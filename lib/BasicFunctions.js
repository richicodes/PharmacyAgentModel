...
//prescription
const LOCdeliveryQueueRow = 3
const LOCdeliveryQueueCol = 5
const LOCnormalQueueRow = 3
const LOCnormalQueueCol = 10
const LOCpriorityQueueRow = 3
const LOCpriorityQueueCol = 15

//prescription
const LOCpickingRow = 5
const LOCpickingCol = 5
const LOCstagingRow = 6
const LOCstagingCol = 6

const LOCcounterRow = 7
const LOCcounterCol = 7

const LOCmissedQueueRow = 8
const LOCmissedQueueCol = 8
const LOCmissedstagingRow = 9 //prescription
const LOCmissedstagingCol = 9 //prescription
const LOCmissedCounterRow = 10
const LOCmissedCounterCol = 10
...
const LOCseatstartcol = 30
const LOCseatendcol = 40
...
var caregivers = [
    ...
    {"type":DISPENSER,"label":"Dispenser","location":{"row":receptionistRow,"col":receptionistCol},"state":DISPENSER_AVAILABLE},
...
// Probabilties
var ProbPatientDelivery = 0.1; // set the patient's likelihood to be a delivery patient
...
function addDynamicAgents(){
	...
	if (Math.random()< probArrival){
        ...
        pat_tolerance = patientMEAN + (0.2)*patientSD// stdNormalDistribution()
		var newpatient = {
            "id":NextPatientID,
            "status":"QDELIVERY",
	...
	switch(state){
		case PATIENT_UNREGISTERED:
            if (hasArrived){
                ...
                console.log("Seat Length"+seatAvailable.length);
                ...
                if (patient.status == QDELIVERY){
                    ...
                    QUEUE_DELIVERY_NEXT ++
                    var intpresc = {"id":patient.id, "status":patient.status,"location":{"row":1,"col":1}, "target":{"row":receptionistRow,"col":receptionistCol}, "state":PRESCRIPTION_REGISTERED,"qnumber":qnumber}
                    ...
                    prescriptions.push({
                        ...
                        "target":{"row":templocationrow,"col":templocationcol},
        ...
        case PATIENT_WALKING:
            if (hasArrived){
                ...
                dispenser.dispenseStop = currentTime + dispenserMEAN + 0.2*dispenserSD;//stdNormalDistribution()*dispenserSD;
            }
        ...
        case PATIENT_MISSEDWALKING:
            ...
            if (hasArrived && 
                ...
                mdispenser.dispenseStop = currentTime + dispenserMEAN + 0.2*dispenserSD;//stdNormalDistribution()*dispenserSD;
            }            
            break;
    ...
    switch(state){
        ...
        case PRESCRIPTION_PRIORITYQUEUE:
            ...
            if (prescription.qnumber == QUEUE_PRIORITY_CALL && 
                ...
                picker.pickStop = currentTime + pickerMEAN + 0.2*pickerSD;//stdNormalDistribution()*pickerSD
        ...
        case PRESCRIPTION_STAGING: 
            ...
            if (dispenser.state == DISPENSER_AVAILABLE && 
                prescription.qnumber == QUEUE_STAGED_CALL){
                    ...
                    var patientIdx = patients.findIndex(patient => patient.id == prescription.id)
