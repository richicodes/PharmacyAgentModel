...
var statistics = [
    ...
    {"name":"Avg time for Prescription to be reach Delivery Office (Delivery): ", "location":{"row": LOCseatendrow+5, "col": LOCseatstartcol}, "cumulativeValue":0,"count":0}
];
/* var statistics = [
