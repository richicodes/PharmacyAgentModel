...
//images
const urlPatientPriority = "images/People-Patient-Male-icon.png";
const urlPatientNormal = "images/People-Patient-Male-icon.png";
const urlPatientDelivery = "images/People-Patient-Male-icon.png";

const urlPillPriority = "images/pill-icon.png";
const urlPillNormal = "images/pill-icon.png";
const urlPillDelivery = "images/pill-icon.png";

// and so on for receptionist, dispenser, picker and counter
...
const LOCmissedstagingCol = 20 //prescription
const LOCmissedCounterRow = 11
const LOCmissedCounterCol = 12
const LOCmdispenserRow = 11
const LOCmdispenserCol = 20

const LOCexitRow = 12
const LOCexitCol = 10
const LOCdeliveryOfficeRow = 7
...
// Probabilties
const ProbPatientDelivery = 0.5; // set the patient's likelihood to be a delivery patient
...
//statistics
var statistics = [
    {"name":"Average time in Pharmacy (Normal): ", "location":{"row": 20, "col": 20}, "length":0},
    {"name":"Average time in Pharmacy (Priority): ", "location":{"row": 21, "col": 20}, "length":0}
];
/* var statistics = [
...
var areas =[
    ...
    {"label":"Prescription Missed Staging","startRow":LOCmissedstagingRow,"numRows":1,"startCol":LOCmissedstagingCol,"numCols":1,"color":"blue"}
]
...
function updateSurface(){
	...
	newcaregivers.append("svg:image")
	 ...
	 .attr("width", Math.min(cellWidth,cellHeight)+"px")
	 .attr("height", Math.min(cellWidth,cellHeight)+"px")
	 .attr("xlink:href",function(d){return urlReceptionist});
...
function updatePrescription(prescriptionIndex){
    ...
    switch(state){
        ...
        case PRESCRIPTION_STAGING: 
            ...
            // in case patient has already excited (call has timed out)
