...
const urlSeat ="images/Chair-icon.png"
...
function updateSurface(){
	...
	//seat object creation
	var allwaitingSeats = surface.selectAll(".waitingSeat").data(waitingSeats);
	var newwaitingSeats = allwaitingSeats.enter().append("g").attr("class","waitingSeat");
	newwaitingSeats.append("svg:image")
...
function addDynamicAgents(){
	...
	if (Math.random()< probArrival){
		...
		"target":{"row":receptionistRow,"col":receptionistCol},"state":UNTREATED,"timeAdmitted":0, "seatNum": -1};
